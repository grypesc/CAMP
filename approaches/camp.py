...
class CAMP(BaseApproach):
    ...
    def train_feature_extractor(self, t, train_dl_dict, valid_dl_dict):
        ...
        student = nn.Sequential(self.backbone, DINOIGCDHead(384, self.total_classes).to(self.device))
        params = list(student.parameters()) + list(cluster_criterion.parameters())
        if t > 0:
